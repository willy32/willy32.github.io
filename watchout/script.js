...
let enemy = [];
let enemyPos = [Math.random() * w, Math.random() * h];
let enemyV = [1, 1];
let enemyDefault = 2;
let enemies = 20;
...
player = new Circle(w / 2, h / 2, 0, 0, enemyDefault + 5, "#138AF2", 0);
...
for(let i = 0; i < enemies; i++){
    ...
    enemy[i] = new Circle(enemyPos[0], enemyPos[1], enemyV[0], enemyV[1], i * enemyDefault + 5, "#C004D9", null);
